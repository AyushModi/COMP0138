...
class DiscreteVAE(nn.Module):
    ...
    def forward(self, c_ids, q_ids, a_ids, start_positions, end_positions,d_ids):
        ...
        d_init_state = self.return_init_state_d(posterior_zd)
        ...
        d_logits, d_loss_info_with_answer,d_loss_info_with_question = self.distractor_decoder(
            d_init_state,q_init_state, c_ids, q_ids, a_ids,d_ids,q_maxouted)
        ...
        loss_info = self.lambda_info * (loss_info+d_loss_info_with_answer+d_loss_info_with_question)
    ...
    def generate(self, zq, za, c_ids,zd):
        ...
        d_init_state = self.return_init_state_d(zd)
        ...
        d_ids = self.distractor_decoder.generate(d_init_state,q_init_state, c_ids, a_ids, q_ids)       ## question generation
