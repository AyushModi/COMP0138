...
class VAETrainer(object):
    def __init__(self, args):
        ...
        self.vae = DiscreteVAE(checkpoint["args"])
    ...
    def train(self, c_ids, q_ids, a_ids, start_positions, end_positions,anneal_kl):
        ...
        loss_info \
        = self.vae(c_ids, q_ids, a_ids, start_positions, end_positions,anneal_kl)
