...
def convert_examples_to_features_answer_id_modified(examples, tokenizer, max_seq_length,
...
def read_squad_answers_from_dict(input_data, is_training, version_2_with_negative=False,
